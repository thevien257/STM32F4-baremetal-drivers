...
int main(void) {
	...
	// Set time to 22:21:45 (24-hour format)
//	DS1307_time_t set_time;
//	set_time.hours = 22;
//	set_time.minutes = 34;
//	set_time.seconds = 45;
...
//	printf("Time set to: %02d:%02d:%02d\r\n", set_time.hours, set_time.minutes,
//			set_time.seconds);
//
//	// Set date to Monday, October 27, 2025
//	DS1307_date_t set_date;
//	set_date.day = MONDAY;
//	set_date.date = 27;
//	set_date.month = 10;
//	set_date.year = 25;  // Last 2 digits of year (2025)
//
//	DS1307_SET_DATE(&I2C_Handle, &set_date);
